...
;(function ($) {
    ...
    var I18nEditor = function (props, element) {
        ...
        this.parse = function (customFormat) {
            ...
            // prh
            if (customFormat == "" ||
                (element.classList.contains('off_zero') &&
                 customFormat == "off"))
                return 0;
        ...
        this.render = function (number) {
           ...
           // prh
            if (element.classList.contains('off_zero') && number == 0)
               return 'off';
    ...
    $.fn.inputSpinner = function (methodOrProps) {
        ...
        this.each(function () {
            ...
            function setValue(newValue, updateInput) {
                ...
                if (isNaN(newValue) || newValue === "") {
                    ...
                    if (updateInput) {
                        ...
                        // prh added this if statement
                        // without it the values do not change

                        if ($input[0].classList.contains("off_zero") && newValue == "off")
                        {
                            value = newValue;
                            return;
                        }
            ...
            function calcStep(step) {
                ...
                var handled = false;
                var thing = $original;
                if (thing.hasClass("off_zero"))
                {
                    var o_min = $original.attr('data-min');
                    if (value==0 && step==1 && o_min > 1)
                        setValue(o_min);
                    else if (value==o_min && step==-1 && o_min > 1)
                        setValue(0);
                    else
